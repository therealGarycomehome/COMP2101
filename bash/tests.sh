...
echo "please enter a number";read firstNumber
echo "please enter a second number";read secondNumber

evenoroddone=$(($firstNumber % 2))
evenoroddtwo=$(($secondNumber % 2))
multiple=$(($second % $firstNumber))
...
[ $evenoroddone -gt 0 ] && echo "The first number is odd"
[ $evenoroddone -eq 0 ] && echo "The first number is even"
[ $evenoroddtwo -gt 0 ] && echo "The second number is odd"
[ $evenoroddtwo -eq 0 ] && echo "The second number is even"
[ $multiple -gt 0 ] && echo "The second number is not a multiple of the first number"
[ $multiple -eq 0 ] && echo "The second number is a multiple of the first numbers"
...
[ -s USER ] && echo "The variable SHELL exists and has content"
...
echo"please enter a number";ready a
echo"please enter a second number";ready b 
