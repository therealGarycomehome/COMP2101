...
while [[ $userguess -eq " " ]]; do
  echo "come on lets have a real guess"
  read -p "Give me a number from 1 to 10: " userguess
done

while [[ $userguess -gt 10 ]]; do
  echo "your number is higher than 10, lets have a real guess"
  read -p "Give me a number from 1 to 10: " userguess
done

while [[ $userguess -eq 0 ]]; do
  echo "your guess is 0 lets have a guess from 1-10 please"
  read -p "Give me a number from 1 to 10: " userguess
done

while [[ $userguess -gt $secretnumber ]]; do
  echo "your guess was higher than the secret number"
  read -p "Give me a number from 1 to 10: " userguess
done

while [[ $userguess -lt $secretnumber ]]; do
  echo "your guess was lower than the secret number"
  read -p "Give me a number from 1 to 10: " userguess
done
